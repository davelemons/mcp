# AWS Labs end-user-messaging MCP Server
...
* [ ] Remove the example tools in `./awslabs/end_user_messaging_mcp_server/server.py`
* [ ] Add your own tool(s) following the [DESIGN_GUIDELINES.md](https://github.com/awslabs/mcp/blob/main/DESIGN_GUIDELINES.md)
* [ ] Keep test coverage at or above the `main` branch - NOTE: GitHub Actions run this command for CodeCov metrics `uv run --frozen pytest --cov --cov-branch --cov-report=term-missing`
* [ ] Document the MCP Server in this "README.md"
* [ ] Add a section for this end-user-messaging MCP Server at the top level of this repository "../../README.md"
* [ ] Create the "../../doc/servers/end-user-messaging-mcp-server.md" file with these contents:

    ```markdown
    ---
    title: end-user-messaging MCP Server
    ---
