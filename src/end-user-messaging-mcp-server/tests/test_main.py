...
from awslabs.end_user_messaging_mcp_server.server import main
...
class TestMain:
    ...
    @patch('awslabs.end_user_messaging_mcp_server.server.mcp.run')
    @patch('sys.argv', ['awslabs.end-user-messaging-mcp-server'])
    ...
    def test_module_execution(self):
        ...
        import inspect
        from awslabs.end_user_messaging_mcp_server import server
